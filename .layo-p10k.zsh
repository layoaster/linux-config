# Generated by Powerlevel10k configuration wizard on 2020-06-03 at 23:41 CEST.
...
# angled separators, round heads, flat tails, 2 lines, dotted, no frame, darkest,
...
() {
  ...
  # To remove the whitespace padding in the right prompt
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=156
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=006
