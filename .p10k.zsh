# Generated by Powerlevel10k configuration wizard on 2021-02-14 at 17:22 WET.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_STATUS_PUSH_COMMITS_BEHIND=$'\uF190 '    # 
  typeset -g POWERLEVEL9K_VCS_STATUS_PUSH_COMMITS_AHEAD=$'\uF18E '     # 
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" ${clean}${POWERLEVEL9K_VCS_STATUS_PUSH_COMMITS_BEHIND}${VCS_STATUS_PUSH_COMMITS_BEHIND}"
    (( VCS_STATUS_PUSH_COMMITS_AHEAD && !VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" "
    # ⇢42 if ahead of the push remote; no leading space if also behind: ⇠42⇢42.
    (( VCS_STATUS_PUSH_COMMITS_AHEAD  )) && res+="${clean}${POWERLEVEL9K_VCS_STATUS_PUSH_COMMITS_AHEAD}${VCS_STATUS_PUSH_COMMITS_AHEAD}"
    # *42 if have stashes.
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_BACKGROUND=104
  ...
  ################[ pyenv: python environment (https://github.com/pyenv/pyenv) ]################
  # Pyenv color.
  typeset -g POWERLEVEL9K_PYENV_FOREGROUND=007
  typeset -g POWERLEVEL9K_PYENV_BACKGROUND=113
